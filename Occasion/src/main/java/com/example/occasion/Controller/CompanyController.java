...
public class CompanyController {
    ...
    @GetMapping("/get")
    public ResponseEntity getAllCompany(@AuthenticationPrincipal MyUser myUser){
    ...
    public ResponseEntity getCompanybyCity(@AuthenticationPrincipal  CompanyDTo companyDTo ) {
